          ...
          <div className="w-full">
            ...
            <div
              className={cn(
                ...
                audioInputLevel > 0.02 &&
                  'after:absolute after:inset-0 after:rounded-md after:ring-2 after:ring-primary/50 after:animate-pulse'
              )}
            >
              <select
                value={selectedInput}
                ...
                disabled={isLoading}
                className={cn(
                  'w-full cursor-pointer rounded-md border border-input bg-background/80 px-2 py-1 text-xs ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
          ...
          <div className="w-full mt-2">
            ...
            >
              <select
                ...
                disabled={isLoading}
                className={cn(
                  'w-full rounded-md cursor-pointer border border-input bg-background/80 px-2 py-1 text-xs ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
        ...
        <div className="flex-1">
          ...
          >
            <select
              ...
              disabled={isLoading}
              className={cn(
                'w-full rounded-md cursor-pointer border border-input bg-background/80 px-3 py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
                audioInputLevel > 0.02 && 'border-primary/50',
                isLoading && 'opacity-50 cursor-not-allowed'
              )}
            >
